...
type Config struct {
	...
	ClarityApiToken  string          `toml:"api_token"`
}
...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("CLARITY_API_TOKEN"); v != "" {
		cfg.ClarityApiToken = v
		cfg.markEnvOverride("ClarityApiToken")
		cfg.AuthSource = "env:CLARITY_API_TOKEN"
		cfg.CredentialSource = "env:CLARITY_API_TOKEN"
	}
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "clarity-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	if c.ClarityApiToken != "" {
		if c.AuthSource == "" {
			c.AuthSource = "env:CLARITY_API_TOKEN"
		}
		return "Bearer " + c.ClarityApiToken
	}
	if c.AccessToken != "" {
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		ClarityApiToken: c.ClarityApiToken,
	}
}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.ClarityApiToken = creds.ClarityApiToken
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.ClarityApiToken = ""
	delete(c.envOverrides, "ClarityApiToken")
	c.updateFileConfigField("ClarityApiToken")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["ClarityApiToken"] {
			out.ClarityApiToken = c.fileConfig.ClarityApiToken
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "ClarityApiToken":
		c.fileConfig.ClarityApiToken = c.ClarityApiToken
	}
}
