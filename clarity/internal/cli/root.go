...
type rootFlags struct {
	...
	// invocation. Mirrors the CLARITY_NO_LEARN env var.
	noLearn       bool
	selectFields  string
	configPath    string
	homePath      string
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "clarity-pp-cli",
		Short: "Manage clarity resources via the clarity API",
		Long: `Manage clarity resources via the clarity API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'clarity-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	...
	rootCmd.AddCommand(newExportDataPromotedCmd(flags))
