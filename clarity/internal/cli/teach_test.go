...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("CLARITY_STATE_DIR", "")
	t.Setenv("CLARITY_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"clarity-pp-cli auth login",
		"clarity-pp-cli doctor",
		"clarity-pp-cli help items",
		"clarity-pp-cli sync",
		"clarity-pp-cli profile list",
		"clarity-pp-cli feedback list",
		"clarity-pp-cli which",
		"clarity-pp-cli agent-context",
		"clarity-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"clarity-pp-cli recall",
		"clarity-pp-cli learnings",
		"clarity-pp-cli teach-pattern",
		"clarity-pp-cli teach-lookup",
		"clarity-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("clarity-pp-cli")); err == nil {
