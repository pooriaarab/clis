...
large datasets as it has no memory pressure.`,
  ...
  clarity-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  clarity-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  clarity-pp-cli export <resource> --format jsonl | jq '.id'`,
