...
type Config struct {
	...
	GoogleAdsOauthToken      string          `toml:"ads_oauth_token"`
...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("GOOGLE_ADS_OAUTH_TOKEN"); v != "" {
		cfg.GoogleAdsOauthToken = v
		cfg.markEnvOverride("GoogleAdsOauthToken")
		cfg.AuthSource = "env:GOOGLE_ADS_OAUTH_TOKEN"
		cfg.CredentialSource = "env:GOOGLE_ADS_OAUTH_TOKEN"
	}
	if v := os.Getenv("GOOGLE_ADS_DEVELOPER_TOKEN"); v != "" {
		cfg.GoogleAdsDeveloperToken = v
		cfg.markEnvOverride("GoogleAdsDeveloperToken")
		cfg.AuthSource = "env:GOOGLE_ADS_DEVELOPER_TOKEN"
		cfg.CredentialSource = "env:GOOGLE_ADS_DEVELOPER_TOKEN"
	}
	if v := os.Getenv("GOOGLE_ADS_LOGIN_CUSTOMER_ID"); v != "" {
		cfg.GoogleAdsLoginCustomerId = v
		cfg.markEnvOverride("GoogleAdsLoginCustomerId")
		cfg.AuthSource = "env:GOOGLE_ADS_LOGIN_CUSTOMER_ID"
		cfg.CredentialSource = "env:GOOGLE_ADS_LOGIN_CUSTOMER_ID"
	}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("GOOGLE_ADS_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "google-ads-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	// A directly-held bearer in GOOGLE_ADS_OAUTH_TOKEN (a pasted access token, or a
	...
	if c.GoogleAdsOauthToken != "" {
		return applyAuthFormat("Bearer {token}", map[string]string{
			"access_token":    c.GoogleAdsOauthToken,
			"token":           c.GoogleAdsOauthToken,
			"ads_oauth_token": c.GoogleAdsOauthToken,
		})
	}
	return ""
}
...
func (c *Config) hasCredentialFields() bool {
	...
	if c.GoogleAdsDeveloperToken != "" {
		return true
	}
	if c.GoogleAdsLoginCustomerId != "" {
		return true
	}
	return false
}
...
func (c *Config) clearCredentialFields() {
	...
	c.ClientID = ""
	c.ClientSecret = ""
	c.GoogleAdsOauthToken = ""
	c.GoogleAdsDeveloperToken = ""
	c.GoogleAdsLoginCustomerId = ""
}
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		GoogleAdsOauthToken:      c.GoogleAdsOauthToken,
		GoogleAdsDeveloperToken:  c.GoogleAdsDeveloperToken,
		GoogleAdsLoginCustomerId: c.GoogleAdsLoginCustomerId,
	}
}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.GoogleAdsOauthToken = creds.GoogleAdsOauthToken
	c.GoogleAdsDeveloperToken = creds.GoogleAdsDeveloperToken
	c.GoogleAdsLoginCustomerId = creds.GoogleAdsLoginCustomerId
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.GoogleAdsOauthToken = ""
	delete(c.envOverrides, "GoogleAdsOauthToken")
	c.updateFileConfigField("GoogleAdsOauthToken")
	c.GoogleAdsDeveloperToken = ""
	delete(c.envOverrides, "GoogleAdsDeveloperToken")
	c.updateFileConfigField("GoogleAdsDeveloperToken")
	c.GoogleAdsLoginCustomerId = ""
	delete(c.envOverrides, "GoogleAdsLoginCustomerId")
	c.updateFileConfigField("GoogleAdsLoginCustomerId")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["GoogleAdsOauthToken"] {
			out.GoogleAdsOauthToken = c.fileConfig.GoogleAdsOauthToken
		}
		if c.envOverrides["GoogleAdsDeveloperToken"] {
			out.GoogleAdsDeveloperToken = c.fileConfig.GoogleAdsDeveloperToken
		}
		if c.envOverrides["GoogleAdsLoginCustomerId"] {
			out.GoogleAdsLoginCustomerId = c.fileConfig.GoogleAdsLoginCustomerId
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "GoogleAdsOauthToken":
		c.fileConfig.GoogleAdsOauthToken = c.GoogleAdsOauthToken
	case "GoogleAdsDeveloperToken":
		c.fileConfig.GoogleAdsDeveloperToken = c.GoogleAdsDeveloperToken
	case "GoogleAdsLoginCustomerId":
		c.fileConfig.GoogleAdsLoginCustomerId = c.GoogleAdsLoginCustomerId
	}
}
