...
type rootFlags struct {
	...
	// invocation. Mirrors the GOOGLE_ADS_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: "Manage google-ads resources via the google-ads API",
		Long: `Manage google-ads resources via the google-ads API.
...
Run 'google-ads-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.AddCommand(newAdGroupAdsPromotedCmd(flags))
	rootCmd.AddCommand(newAdGroupsPromotedCmd(flags))
	rootCmd.AddCommand(newAssetsPromotedCmd(flags))
	rootCmd.AddCommand(newCampaignBudgetsPromotedCmd(flags))
	rootCmd.AddCommand(newCampaignsPromotedCmd(flags))
	rootCmd.AddCommand(newConversionActionsPromotedCmd(flags))
	rootCmd.AddCommand(newMutateResourceCmd(flags)) // hand-written; see internal/cli/mutate_resource.go
