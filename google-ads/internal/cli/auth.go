...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  google-ads-pp-cli auth setup\n  google-ads-pp-cli auth setup --launch",
		RunE: func(cmd *cobra.Command, args []string) error {
			w := cmd.OutOrStdout()
			fmt.Fprintln(w, "No setup URL is configured for this CLI; check the API's docs.")
			fmt.Fprintln(w, "")
			fmt.Fprintln(w, "Then set:")
			fmt.Fprintln(w, "  export GOOGLE_ADS_OAUTH_TOKEN=\"your-token-here\"")
			fmt.Fprintln(w, "  export GOOGLE_ADS_DEVELOPER_TOKEN=\"your-token-here\"")
			fmt.Fprintln(w, "  export GOOGLE_ADS_LOGIN_CUSTOMER_ID=\"your-token-here\"")
			if !launch {
				return nil
			}
...
func newAuthStatusCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  google-ads-pp-cli auth status",
		RunE: func(cmd *cobra.Command, args []string) error {
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  google-ads-pp-cli auth set-token YOUR_TOKEN_HERE",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  google-ads-pp-cli auth logout",
		RunE: func(cmd *cobra.Command, args []string) error {
			cfg, err := config.Load(flags.configPath)
			if err != nil {
				return configErr(err)
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("GOOGLE_ADS_OAUTH_TOKEN") != "" {
				envStillSet = "GOOGLE_ADS_OAUTH_TOKEN"
			}
			if envStillSet == "" && os.Getenv("GOOGLE_ADS_DEVELOPER_TOKEN") != "" {
				envStillSet = "GOOGLE_ADS_DEVELOPER_TOKEN"
			}
			if envStillSet == "" && os.Getenv("GOOGLE_ADS_LOGIN_CUSTOMER_ID") != "" {
				envStillSet = "GOOGLE_ADS_LOGIN_CUSTOMER_ID"
			}
