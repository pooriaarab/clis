...
func newExportCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Export data for backup, migration, or analysis",
...
large datasets as it has no memory pressure.`,
		Example: `# export campaigns to CSV for offline review
google-ads export campaigns --format csv --output campaigns.csv

# export single ad group by id, skip cache since it just changed
google-ads export ad_groups 5551112222 --no-cache

# quick sample export, capped at 50 rows
google-ads export keywords --limit 50`,
