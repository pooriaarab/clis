...
func newSyncCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "sync",
		Short: "Download data locally for offline search and analysis",
...
Resource scoping:
  ...
  from a prior sync.`,
		Example: `# full resync of campaigns and ad_groups after account restructure
google-ads sync --resources campaigns,ad_groups --full

# incremental sync since yesterday, keep pruning off in case of partial failure
google-ads sync --since 2026-07-15 --no-prune

# tightly scoped sync with concurrency limit to avoid rate limit
google-ads sync --resources keywords --concurrency 2 --max-pages 5 --strict`,
