...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("GOOGLE_ADS_STATE_DIR", "")
	t.Setenv("GOOGLE_ADS_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		...
		"google-ads-pp-cli help items",
		"google-ads-pp-cli sync",
		"google-ads-pp-cli profile list",
		"google-ads-pp-cli feedback list",
		"google-ads-pp-cli which",
		"google-ads-pp-cli agent-context",
		"google-ads-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"google-ads-pp-cli recall",
		"google-ads-pp-cli learnings",
		"google-ads-pp-cli teach-pattern",
		"google-ads-pp-cli teach-lookup",
		"google-ads-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("google-ads-pp-cli")); err == nil {
