...
func newAPICmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:         "api [interface]",
		Short:       "Browse available endpoints by interface name",
...
Run 'api <interface>' to see that interface's methods.`,
		Example: `# check GoogleAdsService interface for available RPCs
google-ads api GoogleAdsService

# inspect CampaignService interface before writing mutate ops
google-ads api CampaignService`,
