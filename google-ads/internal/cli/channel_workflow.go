...
func newWorkflowCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:         "workflow",
		Short:       "Chain multiple operations into one workflow",
...
and full resync. After archiving, use 'search' for instant full-text search.`,
		Example: `# see current workflow state
google-ads workflow

# check full workflow with db state included, debugging stale sync
google-ads workflow --full --db`,
