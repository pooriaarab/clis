...
func newWhichCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "which [query]",
		Short: "Find which command does what you need",
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `# figure out which command handles 'budget' related tasks
google-ads which budget

# narrow down matching commands, capped to top 3
google-ads which campaign --limit 3`,
