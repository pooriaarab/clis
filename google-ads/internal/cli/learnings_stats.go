...
func newLearningsStatsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "stats",
		Short: "Show how well the learning loop is working",
...
local-only: events never leave this machine.`,
		Example: `# quick stats check on default db
google-ads stats

# check stats against specific db file after migration
google-ads stats --db ./backup.sqlite`,
