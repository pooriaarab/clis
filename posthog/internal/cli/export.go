...
large datasets as it has no memory pressure.`,
  ...
  posthog-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  posthog-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  posthog-pp-cli export <resource> --format jsonl | jq '.id'`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				...
				"llm-analytics":                 true,
				"organizations":                 true,
				"public-hog-function-templates": true,
				"reminders":                     true,
				"users":                         true,
			}
