...
type rootFlags struct {
	...
	// invocation. Mirrors the POSTHOG_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "posthog-pp-cli",
		Short: "Manage posthog resources via the posthog API",
		Long: `Manage posthog resources via the posthog API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'posthog-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	...
	rootCmd.AddCommand(newAccountRelationshipDefinitionsCmd(flags))
	rootCmd.AddCommand(newAccountsCmd(flags))
	rootCmd.AddCommand(newActionsCmd(flags))
	rootCmd.AddCommand(newAdvancedActivityLogsCmd(flags))
	...
	rootCmd.AddCommand(newApprovalPoliciesCmd(flags))
	rootCmd.AddCommand(newBatchExportsCmd(flags))
	rootCmd.AddCommand(newBusinessKnowledgeCmd(flags))
	rootCmd.AddCommand(newCalendarSyncCmd(flags))
	...
	rootCmd.AddCommand(newCustomPropertyDefinitionsCmd(flags))
	rootCmd.AddCommand(newCustomPropertySourcesCmd(flags))
	rootCmd.AddCommand(newCustomerJourneysCmd(flags))
	rootCmd.AddCommand(newCustomerProfileConfigsCmd(flags))
	rootCmd.AddCommand(newDashboardTemplatesCmd(flags))
	rootCmd.AddCommand(newDashboardsCmd(flags))
	rootCmd.AddCommand(newDataCatalogCmd(flags))
	rootCmd.AddCommand(newDataColorThemesCmd(flags))
	rootCmd.AddCommand(newDataModelingJobsCmd(flags))
	rootCmd.AddCommand(newDataWarehouseCmd(flags))
	rootCmd.AddCommand(newDatasetItemsCmd(flags))
	rootCmd.AddCommand(newDatasetsCmd(flags))
	rootCmd.AddCommand(newEarlyAccessFeatureCmd(flags))
	rootCmd.AddCommand(newElementsCmd(flags))
	rootCmd.AddCommand(newEndpointsCmd(flags))
	rootCmd.AddCommand(newEngineeringAnalyticsCmd(flags))
	rootCmd.AddCommand(newEnvironmentsCmd(flags))
	rootCmd.AddCommand(newErrorTrackingCmd(flags))
	rootCmd.AddCommand(newEvaluationDirectoriesCmd(flags))
	rootCmd.AddCommand(newEvaluationsCmd(flags))
	rootCmd.AddCommand(newEventDefinitionsCmd(flags))
	rootCmd.AddCommand(newEventFilterCmd(flags))
	rootCmd.AddCommand(newEventSchemasCmd(flags))
	rootCmd.AddCommand(newEventStreamsCmd(flags))
	rootCmd.AddCommand(newEventsCmd(flags))
	rootCmd.AddCommand(newExperimentHoldoutsCmd(flags))
	rootCmd.AddCommand(newExperimentSavedMetricsCmd(flags))
	rootCmd.AddCommand(newExperimentsCmd(flags))
	rootCmd.AddCommand(newExportsCmd(flags))
	rootCmd.AddCommand(newExternalDataSchemasCmd(flags))
	rootCmd.AddCommand(newExternalDataSourcesCmd(flags))
	rootCmd.AddCommand(newFeatureFlagsCmd(flags))
	rootCmd.AddCommand(newFieldNotesCmd(flags))
	rootCmd.AddCommand(newFileDownloadBatchExportsCmd(flags))
	rootCmd.AddCommand(newFileSystemCmd(flags))
	rootCmd.AddCommand(newFileSystemShortcutCmd(flags))
	rootCmd.AddCommand(newGroupsCmd(flags))
	rootCmd.AddCommand(newGroupsTypesCmd(flags))
	rootCmd.AddCommand(newHealthIssuesCmd(flags))
	rootCmd.AddCommand(newHeatmapScreenshotsCmd(flags))
	rootCmd.AddCommand(newHeatmapsCmd(flags))
	rootCmd.AddCommand(newHogFlowsCmd(flags))
	rootCmd.AddCommand(newHogFunctionTemplatesCmd(flags))
	rootCmd.AddCommand(newHogFunctionsCmd(flags))
	rootCmd.AddCommand(newInsightVariablesCmd(flags))
	rootCmd.AddCommand(newInsightsCmd(flags))
	rootCmd.AddCommand(newIntegrationsCmd(flags))
	rootCmd.AddCommand(newJsSnippetCmd(flags))
	rootCmd.AddCommand(newLiveDebuggerBreakpointsCmd(flags))
	rootCmd.AddCommand(newLlmAnalyticsCmd(flags))
	rootCmd.AddCommand(newLlmPromptsCmd(flags))
	rootCmd.AddCommand(newLlmSkillsCmd(flags))
	rootCmd.AddCommand(newLogsCmd(flags))
	rootCmd.AddCommand(newLoopsCmd(flags))
	rootCmd.AddCommand(newManagedViewsetsCmd(flags))
	rootCmd.AddCommand(newMarketingAnalyticsCmd(flags))
	rootCmd.AddCommand(newMcpAnalyticsCmd(flags))
	rootCmd.AddCommand(newMcpGatewayCmd(flags))
	rootCmd.AddCommand(newMcpServerInstallationsCmd(flags))
	rootCmd.AddCommand(newMcpToolsCmd(flags))
	rootCmd.AddCommand(newMessagingPreferencesCmd(flags))
	rootCmd.AddCommand(newMessagingSuppressionsCmd(flags))
	rootCmd.AddCommand(newMessagingTemplatesCmd(flags))
	rootCmd.AddCommand(newMetricsCmd(flags))
	rootCmd.AddCommand(newNotebooksCmd(flags))
	rootCmd.AddCommand(newObjectMediaPreviewsCmd(flags))
	rootCmd.AddCommand(newOrganizationsCmd(flags))
	rootCmd.AddCommand(newPersonsCmd(flags))
	rootCmd.AddCommand(newPluginConfigsCmd(flags))
	rootCmd.AddCommand(newPosthogConnectionsCmd(flags))
	rootCmd.AddCommand(newProductToursCmd(flags))
	rootCmd.AddCommand(newProjectSecretApiKeysCmd(flags))
	rootCmd.AddCommand(newPropertyAccessControlsCmd(flags))
	rootCmd.AddCommand(newPropertyDefinitionsCmd(flags))
	rootCmd.AddCommand(newPulseCmd(flags))
	rootCmd.AddCommand(newQueryCmd(flags))
	rootCmd.AddCommand(newRemindersCmd(flags))
	rootCmd.AddCommand(newReviewHogCmd(flags))
	rootCmd.AddCommand(newSandboxCustomImagesCmd(flags))
	rootCmd.AddCommand(newSandboxEnvironmentsCmd(flags))
	rootCmd.AddCommand(newSavedCmd(flags))
	rootCmd.AddCommand(newSavedQueryColumnAnnotationsCmd(flags))
	rootCmd.AddCommand(newScheduledChangesCmd(flags))
	rootCmd.AddCommand(newSchemaPropertyGroupsCmd(flags))
	rootCmd.AddCommand(newSessionGroupSummariesCmd(flags))
	rootCmd.AddCommand(newSessionRecordingPlaylistsCmd(flags))
	rootCmd.AddCommand(newSessionRecordingsCmd(flags))
	rootCmd.AddCommand(newSessionSummariesCmd(flags))
	rootCmd.AddCommand(newSessionsCmd(flags))
	rootCmd.AddCommand(newSignalsCmd(flags))
	rootCmd.AddCommand(newSingleSessionSummariesCmd(flags))
	rootCmd.AddCommand(newStamphogCmd(flags))
	rootCmd.AddCommand(newStreamlitAppsCmd(flags))
	rootCmd.AddCommand(newSubscriptionsCmd(flags))
	rootCmd.AddCommand(newSurveysCmd(flags))
	rootCmd.AddCommand(newTaggersCmd(flags))
	rootCmd.AddCommand(newTaskActivityCmd(flags))
	rootCmd.AddCommand(newTaskAutomationsCmd(flags))
	rootCmd.AddCommand(newTaskChannelsCmd(flags))
	rootCmd.AddCommand(newTasksCmd(flags))
	rootCmd.AddCommand(newTracingCmd(flags))
	rootCmd.AddCommand(newUserHomeSettingsCmd(flags))
	rootCmd.AddCommand(newUserInterviewTopicsCmd(flags))
	rootCmd.AddCommand(newUserInterviewsCmd(flags))
	rootCmd.AddCommand(newUsersCmd(flags))
	rootCmd.AddCommand(newVisionCmd(flags))
	rootCmd.AddCommand(newVisualReviewCmd(flags))
	rootCmd.AddCommand(newWarehouseColumnAnnotationsCmd(flags))
	rootCmd.AddCommand(newWarehouseColumnStatisticsCmd(flags))
	rootCmd.AddCommand(newWarehouseExpressionsCmd(flags))
	rootCmd.AddCommand(newWarehouseModelPathsCmd(flags))
	rootCmd.AddCommand(newWarehouseSavedQueriesCmd(flags))
	rootCmd.AddCommand(newWarehouseSavedQueryFoldersCmd(flags))
	rootCmd.AddCommand(newWarehouseTablesCmd(flags))
	rootCmd.AddCommand(newWarehouseViewLinkCmd(flags))
	rootCmd.AddCommand(newWarehouseViewLinksCmd(flags))
	rootCmd.AddCommand(newWebAnalyticsCmd(flags))
	rootCmd.AddCommand(newWebAnalyticsAchievementsCmd(flags))
	rootCmd.AddCommand(newWebExperimentsCmd(flags))
	rootCmd.AddCommand(newWizardCmd(flags))
	...
	rootCmd.AddCommand(newAccountNotesPromotedCmd(flags))
	rootCmd.AddCommand(newActivityLogPromotedCmd(flags))
	rootCmd.AddCommand(newCustomerAnalyticsPromotedCmd(flags))
	rootCmd.AddCommand(newEvaluationRunsPromotedCmd(flags))
	rootCmd.AddCommand(newFlagValuePromotedCmd(flags))
	rootCmd.AddCommand(newIngestionWarningsV2PromotedCmd(flags))
	rootCmd.AddCommand(newMaxToolsPromotedCmd(flags))
	rootCmd.AddCommand(newMcpServersPromotedCmd(flags))
	rootCmd.AddCommand(newPathsV2PromotedCmd(flags))
	rootCmd.AddCommand(newProductEnablementPromotedCmd(flags))
	rootCmd.AddCommand(newPublicHogFunctionTemplatesPromotedCmd(flags))
	rootCmd.AddCommand(newQuotaLimitsPromotedCmd(flags))
	rootCmd.AddCommand(newSdkHealthPromotedCmd(flags))
	rootCmd.AddCommand(newTaskMentionsPromotedCmd(flags))
	rootCmd.AddCommand(newUploadedMediaPromotedCmd(flags))
	rootCmd.AddCommand(newWarehouseDagPromotedCmd(flags))
	rootCmd.AddCommand(newWebAnalyticsPathCleaningSuggestionsPromotedCmd(flags))
	rootCmd.AddCommand(newWebVitalsPromotedCmd(flags))
