...
func newOrganizationsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List",
		Example:     "  posthog-pp-cli organizations list",
		Annotations: map[string]string{"pp:endpoint": "organizations.list", "pp:method": "GET", "pp:path": "/api/organizations/", "mcp:read-only": "true"},
