...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("POSTHOG_STATE_DIR", "")
	t.Setenv("POSTHOG_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"posthog-pp-cli auth login",
		"posthog-pp-cli doctor",
		"posthog-pp-cli help items",
		"posthog-pp-cli sync",
		"posthog-pp-cli profile list",
		"posthog-pp-cli feedback list",
		"posthog-pp-cli which",
		"posthog-pp-cli agent-context",
		"posthog-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"posthog-pp-cli recall",
		"posthog-pp-cli learnings",
		"posthog-pp-cli teach-pattern",
		"posthog-pp-cli teach-lookup",
		"posthog-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("posthog-pp-cli")); err == nil {
