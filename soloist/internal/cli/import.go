...
but do not stop the import.`,
  ...
  soloist-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  soloist-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | soloist-pp-cli import <resource> --input -`,
