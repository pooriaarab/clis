...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  soloist-pp-cli which "stale tickets"
  soloist-pp-cli which "bottleneck"
  soloist-pp-cli which --limit 1 "send message"
  soloist-pp-cli which                                # list the full capability index`,
