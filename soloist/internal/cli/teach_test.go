...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("SOLOIST_STATE_DIR", "")
	t.Setenv("SOLOIST_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"soloist-pp-cli auth login",
		"soloist-pp-cli doctor",
		"soloist-pp-cli help items",
		"soloist-pp-cli sync",
		"soloist-pp-cli profile list",
		"soloist-pp-cli feedback list",
		"soloist-pp-cli which",
		"soloist-pp-cli agent-context",
		"soloist-pp-cli completion bash",
		"soloist-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"soloist-pp-cli recall",
		"soloist-pp-cli learnings",
		"soloist-pp-cli teach-pattern",
		"soloist-pp-cli teach-lookup",
		"soloist-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("soloist-pp-cli")); err == nil {
