...
type rootFlags struct {
	...
	// invocation. Mirrors the CINEPLEX_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "cineplex-pp-cli",
		Short: "Manage cineplex resources via the cineplex API",
		Long: `Manage cineplex resources via the cineplex API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'cineplex-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("cineplex-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'cineplex-pp-cli profile list')")
	...
	rootCmd.AddCommand(newConcessionsPromotedCmd(flags))
	rootCmd.AddCommand(newExperiencesPromotedCmd(flags))
	rootCmd.AddCommand(newGiftCardsPromotedCmd(flags))
	rootCmd.AddCommand(newLoyaltyPromotedCmd(flags))
	rootCmd.AddCommand(newUtilitiesPromotedCmd(flags))
