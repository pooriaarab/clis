...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("CINEPLEX_STATE_DIR", "")
	t.Setenv("CINEPLEX_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"cineplex-pp-cli auth login",
		"cineplex-pp-cli doctor",
		"cineplex-pp-cli help items",
		"cineplex-pp-cli sync",
		"cineplex-pp-cli profile list",
		"cineplex-pp-cli feedback list",
		"cineplex-pp-cli which",
		"cineplex-pp-cli agent-context",
		"cineplex-pp-cli completion bash",
		"cineplex-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"cineplex-pp-cli recall",
		"cineplex-pp-cli learnings",
		"cineplex-pp-cli teach-pattern",
		"cineplex-pp-cli teach-lookup",
		"cineplex-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("cineplex-pp-cli")); err == nil {
