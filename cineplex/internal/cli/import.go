...
but do not stop the import.`,
  ...
  cineplex-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  cineplex-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | cineplex-pp-cli import <resource> --input -`,
