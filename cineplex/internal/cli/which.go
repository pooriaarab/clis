...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  cineplex-pp-cli which "stale tickets"
  cineplex-pp-cli which "bottleneck"
  cineplex-pp-cli which --limit 1 "send message"
  cineplex-pp-cli which                                # list the full capability index`,
