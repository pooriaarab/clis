...
large datasets as it has no memory pressure.`,
  ...
  cineplex-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  cineplex-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  cineplex-pp-cli export <resource> --format jsonl | jq '.id'`,
