...
import (
	...
	"taboola-pp-cli/internal/client"
	"taboola-pp-cli/internal/config"
)
...
var platform = spec{
	Name: "taboola", Display: "Taboola Backstage", Env: "TABOOLA", BaseURL: "https://backstage.taboola.com", Mode: "api",
	Accounts: "", Campaigns: "/backstage/api/1.0/{account}/campaigns/", CampaignCreate: "/backstage/api/1.0/{account}/campaigns/", Audiences: "", AudienceCreate: "", Report: "/backstage/api/1.0/{account}/reports/campaign-summary/dimensions/day", Todo: "Taboola's public advertiser docs cover campaigns and standard reports. Audience uploads are not added without a verified current endpoint.",
}
