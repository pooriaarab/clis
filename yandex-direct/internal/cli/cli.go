...
import (
	...
	"yandex-direct-pp-cli/internal/client"
	"yandex-direct-pp-cli/internal/config"
)
...
var platform = spec{
	Name: "yandex-direct", Display: "Yandex Direct", Env: "YANDEX_DIRECT", BaseURL: "https://api.direct.yandex.com", Mode: "api",
	Accounts: "", Campaigns: "", CampaignCreate: "", Audiences: "", AudienceCreate: "", Report: "/json/v501/reports", Todo: "The reports command posts JSON to the documented v501 reports endpoint. Campaign and audience method coverage remains TODO until generated from the current method reference.",
}
