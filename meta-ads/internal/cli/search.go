...
Run sync first to populate the local search index.`,
  ...
  meta-ads-pp-cli search "status"

  # Force local search explicitly
  meta-ads-pp-cli search "status" --data-source local
  # Search a specific resource type locally
  meta-ads-pp-cli search "status" --type act-ad-account-id --data-source local
  # JSON output for piping
  meta-ads-pp-cli search "status" --json --limit 20`,
