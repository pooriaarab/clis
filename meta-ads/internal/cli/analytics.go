...
func newAnalyticsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "analytics",
		Short:       "Run analytics queries on synced data",
...
Data must be synced first with the sync command.`,
		Example: `# check win rate by campaign type this week
meta-ads analytics --type performance --group-by campaign_type --limit 20

# switch to staging db while debugging analytics discrepancy
meta-ads analytics --type spend --group-by day --db staging.sqlite --limit 30`,
