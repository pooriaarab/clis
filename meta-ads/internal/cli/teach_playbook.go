...
func newTeachPlaybookCmd(flags *rootFlags, learnCfg *entities.Config) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "teach-playbook",
		Short: "Save a playbook and notes for a query",
...
agents can record playbooks without a file on disk.`,
		Example: `# push a reviewed playbook doc into the live playbook
meta-ads teach-playbook --playbook-file playbooks/q3-strategy.json

# annotate existing playbook entry with a follow-up note
meta-ads teach-playbook --query "lookalike audiences" --add-note "works best above $500/day spend"`,
