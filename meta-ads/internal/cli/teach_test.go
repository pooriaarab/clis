...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("META_ADS_STATE_DIR", "")
	t.Setenv("META_ADS_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		...
		"meta-ads-pp-cli help items",
		"meta-ads-pp-cli sync",
		"meta-ads-pp-cli profile list",
		"meta-ads-pp-cli feedback list",
		"meta-ads-pp-cli which",
		"meta-ads-pp-cli agent-context",
		"meta-ads-pp-cli completion bash",
		"meta-ads-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"meta-ads-pp-cli recall",
		"meta-ads-pp-cli learnings",
		"meta-ads-pp-cli teach-pattern",
		"meta-ads-pp-cli teach-lookup",
		"meta-ads-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("meta-ads-pp-cli")); err == nil {
