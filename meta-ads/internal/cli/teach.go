...
// meta-ads-pp-cli CLI: `teach` (fire-and-forget, silent on success,
...
import (
	...
	"meta-ads-pp-cli/internal/learn/entities"
	"meta-ads-pp-cli/internal/learn/lookups"
	"meta-ads-pp-cli/internal/learn/patterns"
...
const noLearnEnvVar = "META_ADS_NO_LEARN"
...
func learnDBPath(explicit string) string {
	...
	return defaultDBPath("meta-ads-pp-cli")
}
...
func newTeachCmd(flags *rootFlags, learnCfg *entities.Config) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "teach",
		Short: "Save a query-to-resource mapping",
...
Disabling: pass --no-learn or set ` + noLearnEnvVar + `=true.`,
		Example: `# teach the agent a naming convention it kept missing
meta-ads teach --query "campaign naming" --resource campaign --notes "prefix with region code, e.g. US-, EU-"

# load a structured playbook rule from file, quiet mode for scripting
meta-ads teach --playbook-file rules/budget-caps.json --quiet

# check existing teachings before adding a duplicate
meta-ads teach --query "budget" --resource adset --limit 10`,
