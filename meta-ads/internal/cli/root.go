...
type rootFlags struct {
	...
	// invocation. Mirrors the META_ADS_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "meta-ads-pp-cli",
		Short: "Manage meta-ads resources via the meta-ads API",
		Long: `Manage meta-ads resources via the meta-ads API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'meta-ads-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	...
	rootCmd.AddCommand(newActAdAccountIdCmd(flags))
	...
	rootCmd.AddCommand(newGenericNodeCmd(flags)) // hand-written; see internal/cli/generic_node.go
	rootCmd.AddCommand(newGenericEdgeCmd(flags)) // hand-written; see internal/cli/generic_node.go
