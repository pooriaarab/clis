...
import (
	...
	"apple-search-ads-pp-cli/internal/client"
	"apple-search-ads-pp-cli/internal/config"
)
...
var platform = spec{
	Name: "apple-search-ads", Display: "Apple Search Ads", Env: "APPLE_SEARCH_ADS", BaseURL: "https://api.searchads.apple.com", Mode: "api",
	Accounts: "", Campaigns: "/api/v5/campaigns", CampaignCreate: "/api/v5/campaigns", Audiences: "", AudienceCreate: "", Report: "/api/v5/reports/campaigns", Todo: "Apple Search Ads does not expose a customer-match upload operation in the verified API pages used for this print. Audience upload remains TODO.",
}
