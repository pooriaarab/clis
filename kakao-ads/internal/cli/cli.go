...
import (
	...
	"kakao-ads-pp-cli/internal/client"
	"kakao-ads-pp-cli/internal/config"
)
...
var platform = spec{
	Name: "kakao-ads", Display: "Kakao Moment", Env: "KAKAO_ADS", BaseURL: "https://apis.moment.kakao.com", Mode: "api",
	Accounts: "", Campaigns: "", CampaignCreate: "", Audiences: "", AudienceCreate: "", Report: "/openapi/v4/campaigns/report", Todo: "The verified command covers campaign reports with a business token. Campaign writes, audience uploads, and account reads remain TODO.",
}
