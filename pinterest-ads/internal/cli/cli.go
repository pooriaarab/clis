...
import (
	...
	"pinterest-ads-pp-cli/internal/client"
	"pinterest-ads-pp-cli/internal/config"
)
...
var platform = spec{
	Name: "pinterest-ads", Display: "Pinterest Ads", Env: "PINTEREST_ADS", BaseURL: "https://api.pinterest.com", Mode: "api",
	Accounts: "/v5/ad_accounts", Campaigns: "/v5/ad_accounts/{account}/campaigns", CampaignCreate: "/v5/ad_accounts/{account}/campaigns", Audiences: "/v5/ad_accounts/{account}/audiences", AudienceCreate: "/v5/ad_accounts/{account}/customer_lists", Report: "/v5/ad_accounts/{account}/campaigns/analytics", Todo: "Audience uploads use the documented customer_lists endpoint. The audience list command uses the documented audiences resource.",
}
...
func accounts(c *client.Client) *cobra.Command {
	group := &cobra.Command{Use: "accounts"}
...
func reporting(c *client.Client) *cobra.Command {
	group := &cobra.Command{Use: "reporting"}
	cmd := &cobra.Command{Use: "get [ACCOUNT]", Args: cobra.MaximumNArgs(1)}
	var body string
