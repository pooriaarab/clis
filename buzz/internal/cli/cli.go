...
func NewRootCommand() (*cobra.Command, *rootOptions) {
	...
	root.AddCommand(workflowsCommand(opts))
	...
	root.AddCommand(mediaCommand(opts))
	root.AddCommand(uploadCommand(opts))
	root.AddCommand(memCommand(opts))
	root.AddCommand(packCommand(opts))
	root.AddCommand(moderationCommand(opts))
