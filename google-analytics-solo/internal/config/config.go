...
type Config struct {
	...
	GoogleApplicationCredentials string          `toml:"application_credentials"`
...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("GOOGLE_APPLICATION_CREDENTIALS"); v != "" {
		...
		cfg.markEnvOverride("GoogleApplicationCredentials")
		cfg.AuthSource = "env:GOOGLE_APPLICATION_CREDENTIALS"
		cfg.CredentialSource = "env:GOOGLE_APPLICATION_CREDENTIALS"
	}
	if v := os.Getenv("GOOGLE_ANALYTICS_DATA_OAUTH2C"); v != "" {
		cfg.GoogleAnalyticsDataOauth2c = v
		cfg.markEnvOverride("GoogleAnalyticsDataOauth2c")
		cfg.AuthSource = "env:GOOGLE_ANALYTICS_DATA_OAUTH2C"
		cfg.CredentialSource = "env:GOOGLE_ANALYTICS_DATA_OAUTH2C"
	}
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "google-analytics-solo-pp-cli", "config.toml"), nil
}
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		GoogleAnalyticsDataOauth2c:   c.GoogleAnalyticsDataOauth2c,
	}
}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.GoogleApplicationCredentials = creds.GoogleApplicationCredentials
	c.GoogleAnalyticsDataOauth2c = creds.GoogleAnalyticsDataOauth2c
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.GoogleApplicationCredentials = ""
	delete(c.envOverrides, "GoogleApplicationCredentials")
	c.updateFileConfigField("GoogleApplicationCredentials")
	c.GoogleAnalyticsDataOauth2c = ""
	delete(c.envOverrides, "GoogleAnalyticsDataOauth2c")
	c.updateFileConfigField("GoogleAnalyticsDataOauth2c")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["GoogleApplicationCredentials"] {
			out.GoogleApplicationCredentials = c.fileConfig.GoogleApplicationCredentials
		}
		if c.envOverrides["GoogleAnalyticsDataOauth2c"] {
			out.GoogleAnalyticsDataOauth2c = c.fileConfig.GoogleAnalyticsDataOauth2c
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "GoogleApplicationCredentials":
		c.fileConfig.GoogleApplicationCredentials = c.GoogleApplicationCredentials
	case "GoogleAnalyticsDataOauth2c":
		c.fileConfig.GoogleAnalyticsDataOauth2c = c.GoogleAnalyticsDataOauth2c
	}
}
