...
native streaming instead of polling.`,
  ...
  google-analytics-solo-pp-cli tail --interval 10s

  # Tail a specific resource
  google-analytics-solo-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  google-analytics-solo-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
