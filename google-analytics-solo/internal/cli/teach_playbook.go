...
agents can record playbooks without a file on disk.`,
		Example: `  google-analytics-solo-pp-cli teach-playbook \
...
Disabling: pass --no-learn or set ` + noLearnEnvVar + `=true.`,
		Example: `  google-analytics-solo-pp-cli playbook amend \
...
func newPlaybookListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     `  google-analytics-solo-pp-cli playbook list --agent`,
