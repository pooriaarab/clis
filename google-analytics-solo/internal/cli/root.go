...
Health check: run 'google-analytics-solo-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("google-analytics-solo-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'google-analytics-solo-pp-cli profile list')")
	...
	rootCmd.AddCommand(newGoogleAnalyticsAdminPropertiesCmd(flags))
	...
	rootCmd.AddCommand(newNovelMetadataCmd(flags))
	rootCmd.AddCommand(newNovelReportCmd(flags))
	rootCmd.AddCommand(newNovelTrendCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAccountSummariesPromotedCmd(flags))
	rootCmd.AddCommand(newAccountsProvisionAccountTicketPromotedCmd(flags))
	rootCmd.AddCommand(newPropertiesCreateConnectedSiteTagPromotedCmd(flags))
	rootCmd.AddCommand(newPropertiesDeleteConnectedSiteTagPromotedCmd(flags))
	rootCmd.AddCommand(newPropertiesFetchAutomatedGa4ConfigurationOptOutPromotedCmd(flags))
	rootCmd.AddCommand(newPropertiesFetchConnectedGa4PropertyPromotedCmd(flags))
	rootCmd.AddCommand(newPropertiesListConnectedSiteTagsPromotedCmd(flags))
	rootCmd.AddCommand(newPropertiesSetAutomatedGa4ConfigurationOptOutPromotedCmd(flags))
