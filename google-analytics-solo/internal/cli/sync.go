...
import (
	...
	"google-analytics-solo-pp-cli/internal/learn/lookups"
...
Resource scoping:
  ...
  google-analytics-solo-pp-cli sync

  # Sync specific resources only
  google-analytics-solo-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  google-analytics-solo-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  google-analytics-solo-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  google-analytics-solo-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  google-analytics-solo-pp-cli sync --latest-only`,
...
func determinePaginationDefaults(resource string) paginationDefaults {
	...
	case "google-analytics-admin-properties/access_bindings":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
	...
	case "google-analytics-admin-properties/audiences":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
	...
	case "google-analytics-admin-properties/big_query_links":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
	...
	case "google-analytics-admin-properties/channel_groups":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
	...
	case "google-analytics-admin-properties/conversion_events":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
	...
	case "google-analytics-admin-properties/custom_dimensions":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
	...
	case "google-analytics-admin-properties/custom_metrics":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
	...
	case "google-analytics-admin-properties/display_video360_advertiser_link_proposals":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
	...
	case "google-analytics-admin-properties/display_video360_advertiser_links":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
	...
	case "google-analytics-admin-properties/expanded_data_sets":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
	...
	case "google-analytics-admin-properties/firebase_links":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
	...
	case "google-analytics-admin-properties/google_ads_links":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
	...
	case "google-analytics-admin-properties/google_analytics_admin_properties_data_streams":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
	...
	case "google-analytics-admin-properties/search_ads360_links":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
	...
	case "google-analytics-admin-properties/user_links":
		return paginationDefaults{
			cursorParam: "pageToken",
			cursorType:  "page_token",
			limitParam:  "pageSize",
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "account-summaries":
		return db.UpsertAccountSummaries(data)
	case "accounts":
		return db.UpsertAccounts(data)
	case "measurement_protocol_secrets":
		return db.UpsertMeasurementProtocolSecrets(data)
	case "google-analytics-admin-properties":
		return db.UpsertGoogleAnalyticsAdminProperties(data)
	case "access_bindings":
		return db.UpsertAccessBindings(data)
	case "audiences":
		return db.UpsertAudiences(data)
	case "big_query_links":
		return db.UpsertBigQueryLinks(data)
	case "channel_groups":
		return db.UpsertChannelGroups(data)
	case "conversion_events":
		return db.UpsertConversionEvents(data)
	case "custom_dimensions":
		return db.UpsertCustomDimensions(data)
	case "custom_metrics":
		return db.UpsertCustomMetrics(data)
	case "google_analytics_admin_properties_data_streams":
		return db.UpsertGoogleAnalyticsAdminPropertiesDataStreams(data)
	case "display_video360_advertiser_link_proposals":
		return db.UpsertDisplayVideo360AdvertiserLinkProposals(data)
	case "display_video360_advertiser_links":
		return db.UpsertDisplayVideo360AdvertiserLinks(data)
	case "expanded_data_sets":
		return db.UpsertExpandedDataSets(data)
	case "firebase_links":
		return db.UpsertFirebaseLinks(data)
	case "google_ads_links":
		return db.UpsertGoogleAdsLinks(data)
	case "search_ads360_links":
		return db.UpsertSearchAds360Links(data)
	case "user_links":
		return db.UpsertUserLinks(data)
	case "properties":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		"account-summaries":                 "/v1alpha/accountSummaries",
		"accounts":                          "/v1alpha/accounts",
		"google-analytics-admin-properties": "/v1alpha/properties",
		"measurement-protocol-secrets":      "/v1alpha/{parent}/measurementProtocolSecrets",
	}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "access_bindings", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/accessBindings", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
		{Name: "audiences", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/audiences", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
		{Name: "big_query_links", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/bigQueryLinks", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
		{Name: "channel_groups", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/channelGroups", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
		{Name: "conversion_events", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/conversionEvents", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
		{Name: "custom_dimensions", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/customDimensions", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
		{Name: "custom_metrics", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/customMetrics", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
		{Name: "display_video360_advertiser_link_proposals", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/displayVideo360AdvertiserLinkProposals", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
		{Name: "display_video360_advertiser_links", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/displayVideo360AdvertiserLinks", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
		{Name: "expanded_data_sets", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/expandedDataSets", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
		{Name: "firebase_links", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/firebaseLinks", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
		{Name: "google_ads_links", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/googleAdsLinks", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
		{Name: "google_analytics_admin_properties_data_streams", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/dataStreams", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
		{Name: "search_ads360_links", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/searchAds360Links", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
		{Name: "user_links", ParentTable: "google-analytics-admin-properties", ParentIDParam: "parent", PathTemplate: "/v1alpha/{parent}/userLinks", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.google-analytics-admin-property", PathParams: []dependentPathParamDef{
			{Param: "parent", Field: "name"},
		}},
	}
}
...
var reconcileTypedTables = map[string]string{
	...
	"account-summaries": "account_summaries",
	"accounts":          "accounts",
	"audiences":         "audiences",
	"big_query_links":   "big_query_links",
	"channel_groups":    "channel_groups",
	"conversion_events": "conversion_events",
	"custom_dimensions": "custom_dimensions",
	"custom_metrics":    "custom_metrics",
	"display_video360_advertiser_link_proposals":     "display_video360_advertiser_link_proposals",
	"display_video360_advertiser_links":              "display_video360_advertiser_links",
	"expanded_data_sets":                             "expanded_data_sets",
	"firebase_links":                                 "firebase_links",
	"google-analytics-admin-properties":              "google_analytics_admin_properties",
	"google_ads_links":                               "google_ads_links",
	"google_analytics_admin_properties_data_streams": "google_analytics_admin_properties_data_streams",
	"measurement_protocol_secrets":                   "measurement_protocol_secrets",
	"properties":                                     "properties",
	"search_ads360_links":                            "search_ads360_links",
...
func responsePathForResource(resource, path string) []string {
	...
	case "account-summaries\x00/v1alpha/accountSummaries":
		return []string{"accountSummaries"}
	case "accounts\x00/v1alpha/accounts":
		return []string{"accounts"}
	case "accounts\x00/v1alpha/{account}:searchChangeHistoryEvents":
		return []string{"changeHistoryEvents"}
	case "google-analytics-admin-properties\x00/v1alpha/properties":
		return []string{"properties"}
	case "properties\x00/v1beta/{property}:batchRunPivotReports":
		return []string{"pivotReports"}
	case "properties\x00/v1beta/{property}:batchRunReports":
		return []string{"reports"}
	case "properties-list-connected-site-tags\x00/v1alpha/properties:listConnectedSiteTags":
		return []string{"connectedSiteTags"}
	}
	return nil
}
