...
but do not stop the import.`,
  ...
  google-analytics-solo-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  google-analytics-solo-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | google-analytics-solo-pp-cli import <resource> --input -`,
