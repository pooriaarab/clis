...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"google-analytics-solo-pp-cli auth login",
		"google-analytics-solo-pp-cli doctor",
		"google-analytics-solo-pp-cli help items",
		"google-analytics-solo-pp-cli sync",
		"google-analytics-solo-pp-cli profile list",
		"google-analytics-solo-pp-cli feedback list",
		"google-analytics-solo-pp-cli which",
		"google-analytics-solo-pp-cli agent-context",
		"google-analytics-solo-pp-cli completion bash",
		"google-analytics-solo-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"google-analytics-solo-pp-cli recall",
		"google-analytics-solo-pp-cli learnings",
		"google-analytics-solo-pp-cli teach-pattern",
		"google-analytics-solo-pp-cli teach-lookup",
		"google-analytics-solo-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("google-analytics-solo-pp-cli")); err == nil {
