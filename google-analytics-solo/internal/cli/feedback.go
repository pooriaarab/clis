...
func postFeedback(url string, entry FeedbackEntry) error {
	...
	req.Header.Set("User-Agent", "google-analytics-solo-pp-cli/feedback")
...
maintainer sees it.`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			entry := FeedbackEntry{
				Text:      text,
				CLI:       "google-analytics-solo-pp-cli",
				Version:   version,
...
func newFeedbackListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  google-analytics-solo-pp-cli feedback list
  google-analytics-solo-pp-cli feedback list --limit 5
  google-analytics-solo-pp-cli feedback list --json`,
