# Outbrain Amplify CLI

This printed CLI provides a non-interactive token workflow for Outbrain Amplify.

## Install

Run go build ./... from this directory. The binary is outbrain-pp-cli.
...
Create or approve an app in the official developer console. Follow the platform's access steps in the links below. Then run:
    ...
    outbrain-pp-cli auth set-token YOUR_ACCESS_TOKEN

You can also set OUTBRAIN_ACCESS_TOKEN. Check the local setup with:

    outbrain-pp-cli doctor
